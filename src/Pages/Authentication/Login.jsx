    ...
    return (
        <div className="py-16">
            <div className="w-full mx-auto max-w-sm p-4 border bg-gradient-to-r from-blue-300 via-sky-300 to-blue-400  border-gray-200 rounded-lg shadow sm:p-6 md:p-8">
                ...
                <button className="border-2 border-purple-600 bg-slate-100 rounded-lg py-3 px-4 mt-6 flex gap-4 justify-center font-semibold w-full">
                ...
                <form className="space-y-4" >
                    ...
                    <div className="text-sm font-medium text-gray-500">
                        Not registered yet? <Link to='/register'><button className="text-blue-700 hover:underline dark:text-blue-500">Login</button></Link>
                    </div>
                </form>
            </div>
        </div>
